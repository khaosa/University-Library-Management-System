...
public class TestLibrarianRole {
    ...
    public static void test1() {
        ...
        BookDatabase b = new BookDatabase("Books.txt");
        librarian.setBooksDatabase(b);
        StudentBookDatabase b2 = new StudentBookDatabase("StudentBooks.txt");
        librarian.setStudentBooksDatabase(b2);
